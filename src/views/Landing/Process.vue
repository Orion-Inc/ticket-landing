<template>
    <div class="-d-none">
        <section class="section section section-shaped my-0 bg-gradient-default overflow-hidden">
        ...
        <section class="section section-shaped my-0 overflow-hidden bg-gradient-default">
