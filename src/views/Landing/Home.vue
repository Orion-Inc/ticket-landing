    ...
    <div class="">
        ...
        <div class="position-relative">
            <section class="section section-shaped section-lg my-0 bg-gradient-default">
                <div class="container shape-container d-flex pt-5">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">A Tickets System
                                    <span>developed by teejay &amp; farid</span>
                                </h1>
                                <p class="lead  text-white">The system enables users to buy ticket for events and the cinema. Also event orgaizers can create custom events.</p>
                        ...
                        <div class="row row-grid">
                            <div class="offset-lg-1 col-lg-5">
                                <card class="border-0" hover shadow body-classes="py-4">
                                    ...
                                    <p class="description mt-3">Some text about all events that have been enlisted.</p>
                                    
                                    <base-button tag="a" href="discover/events" outline size="sm" type="secondary" class="mt-2 text-capitalize">
                                        Discover
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-5">
                                <card class="border-0" hover shadow body-classes="py-4">
                                    <h6 class="text-primary text-uppercase">Movies</h6>
                                    <p class="description mt-3">Some text about the movies showing and what not.</p>
                                    
                                    <base-button tag="a" href="discover/movies" outline size="sm" type="secondary" class="mt-2 text-capitalize">
                                        What's showing?
                                    </base-button>
                                </card>
                            </div>
        ...
        <section class="d-none section section-lg">
            <div class="container">
        ...
        <section class="d-none section bg-secondary">
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
        ...
        <section class="d-none section section section-shaped my-0 overflow-hidden">
        ...
        <section class="d-none section section-lg pt-0">
            <div class="container">
        ...
        <section class="d-none section section-shaped my-0 overflow-hidden">
        ...
        <section class="d-none ssection section-lg pt-lg-0 section-contact-us">
            <div class="container">
